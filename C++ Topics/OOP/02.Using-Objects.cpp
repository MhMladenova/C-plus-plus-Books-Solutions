...
// NOTE: A better approach is using methods on the Person class.
...
int main()
{
    ...
    // NOTE: this is not the proper way to initialize an object. The proper way is using constructors
    person.name = "Lorem";
    person.age = 42;
